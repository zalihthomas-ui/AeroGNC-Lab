...
18-state backend, matched cross-model evidence, and truth-isolated estimated waypoint
navigation with fixed-lag outage/recovery evidence. The release does not claim
